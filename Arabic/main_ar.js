...
//sideBar
fetch("folders/components/side_bar_ar/sideBar_ar.html")
  .then((res) => res.text())
  .then((data) => {
...
if (!document.getElementById(headerjsId)) {
  ...
  headerScirpt.src = "folders/components/header_ar/header_ar.js";
  document.head.appendChild(headerScirpt);
}

//request service
fetch("folders/components/request_service_ar/requestService_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(requestjsId)) {
      ...
      requestScirpt.src = "folders/components/request_service_ar/request_ar.js";
...
//home
fetch("folders/components/home_ar/home_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(homejsId)) {
      ...
      homeScirpt.src = "folders/components/home_ar/home_ar.js";
...
document.addEventListener("mousemove", (e) => {
  mouseMove.style.transform = `translate(${e.clientX - window.innerWidth + 80}px, ${
    e.clientY - 50
  }px)`;
});

//about US
fetch("folders/components/about_Us_ar/aboutUs_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(aboutjsId)) {
      ...
      aboutScirpt.src = "folders/components/about_Us_ar/aboutUs_ar.js";
      document.head.appendChild(aboutScirpt);
    }
  });

//services
fetch("folders/components/our_services_ar/services_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(servicesjsId)) {
      ...
      servicesScirpt.src = "folders/components/our_services_ar/services_ar.js";
      document.head.appendChild(servicesScirpt);
    }
  });

//imprtatnt works page
fetch("folders/components/important_Works_ar/importantWorks_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(catejsId)) {
      ...
      cateScirpt.src = "folders/components/important_Works_ar/importantWorks_ar.js";
      document.head.appendChild(cateScirpt);
    }
  });

//blog Agency page
fetch("folders/components/blog_Agency_ar/blog_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(blogjsId)) {
      ...
      blogScirpt.src = "folders/components/blog_Agency_ar/blog_ar.js";
      document.head.appendChild(blogScirpt);
    }
  });

//partners page
fetch("folders/components/partners_ar/partners_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(partnersjsId)) {
      ...
      partnersScirpt.src = "folders/components/partners_ar/partners_ar.js";
      document.head.appendChild(partnersScirpt);
    }
  });

//said about us page
fetch("folders/components/said_aboutUs_ar/saidAboutUs_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(saidjsId)) {
      ...
      saidScirpt.src = "folders/components/said_aboutUs_ar/saidAboutUs_ar.js";
      document.head.appendChild(saidScirpt);
    }
  });

//contact us page
fetch("folders/components/contact_ar/contact_ar.html")
  .then((res) => res.text())
  .then((data) => {
    ...
    if (!document.getElementById(contactjsId)) {
      ...
      contactScirpt.src = "folders/components/contact_ar/contact_ar.js";
